...
|------|------|---------|--------|
| 1–8 | Função SE (Introdução, Variações e Exercícios) | ~76min | ✅ |
| 9–12 | Funções Lógicas (E / OU) | ~44min | ✅ |
| 13–16 | CONT.SES (Introdução e Exercício) | ~42min | ✅ |
| 17–20 | SOMASES (Introdução e Exercício) | ~35min | ✅ |
| 21–22 | Trancamento Parcial | ~25min | ✅ |
| 23–25 | MÉDIASES / MÁXIMOSES / MÍNIMOSES | ~29min | ✅ |
| 26–29 | Exercícios CONT.SES / SOMASES | ~55min | ✅ |
| 30–41 | PROCV (Introdução ao Avançado) | ~176min | ✅ |
| 42 | Uso de Asterisco (*) | 13min | ✅ |
| 43–46 | SEERRO (Busca em Múltiplas Colunas) | ~36min | ✅ |
| 47–49 | PROCH e Limitações do PROCV | ~24min | ✅ |
| 50–55 | PROCX (Introdução ao Avançado) | ~75min | ✅ |
| 56–61 | ÍNDICE + CORRESP | ~79min | ✅ |
| 62–65 | DESLOC | ~56min | ✅ |
| 66–71 | INDIRETO | ~75min | ✅ |
| 72 | SOMARPRODUTO | 10min | ✅ |
| 73–79 | Exercícios Gerais (SE, PROCV, ÍNDICE, CORRESP, INDIRETO) | ~73min | ✅ |
